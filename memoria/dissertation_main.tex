...
\title{Computación Ubicua e \\ Inteligencia Ambiental. \\ \\Learn2Cube: Aprendizaje de Resolución del Cubo de Rubik.}
                                                    % note capitalization of the title (only common 
                                                    % words in lower case)
\tagline{OpenCV, Realidad Aumentada, Reconocimiento de Imágenes, Procesamiento de Lenguaje Natural}                     % tag line
...
\mainmatter 
    ...
    \input{chap2/desarrollo} 
    \input{chap3/conclusiones}
    %\appendix
...
{\backmatter
    ...
    {\footnotesize\bibliography{chap1/bibliografia.bib}}
	\printindex
}
